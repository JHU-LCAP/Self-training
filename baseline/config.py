...
workspace = ".."
# DESED Paths
weak = os.path.join(dataspace, 'dataset/metadata/train/weak.tsv')
unlabel = os.path.join(dataspace, 'dataset/metadata/train/unlabel_in_domain.tsv')
synthetic = os.path.join(dataspace, 'dataset/metadata/train/synthetic20/soundscapes.tsv')
validation = os.path.join(dataspace, 'dataset/metadata/validation/validation.tsv')
...
audio_validation_dir = os.path.join(dataspace, 'dataset/audio/validation')
# Separated data
